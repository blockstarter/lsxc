...
(function(){
  var fs, reactify, browserifyInc, livescript, browserify, xtend, commander, sassc, save;
  fs = require('fs');
  ...
  module.exports = function(commander){
    var basedir, file, target, ref$, bundle, html, sass, compilesass, input, code, js, state, err, makeBundle;
    basedir = process.cwd();
