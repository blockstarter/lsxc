...
(function(){
  var fs, through, reactify, browserifyInc, livescript, browserify, xtend, sassc, watch, basedir, sassCache, path, sassC, save, setupWatch, compileFile, compile;
  fs = require('fs');
