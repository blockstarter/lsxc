...
(function(){
  var fs, reactify, browserifyInc, livescript, browserify, xtend, commander, colors, opt, file, target, ref$, bundle, html, code, js, basedir, makeBundle;
  fs = require('fs');
  ...
  code = reactify(fs.readFileSync(file + ".ls").toString('utf-8'));
